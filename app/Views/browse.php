        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="featured-games header-text">
              ...
              <div class="owl-features owl-carousel">
                <div class="item">
                  <div class="thumb">
                    <img src="<?= $template ?>/images/featured-01.jpg" alt="">
                ...
                <div class="item">
                  <div class="thumb">
                    <img src="<?= $template ?>/images/featured-02.jpg" alt="">
                    <div class="hover-effect">
                      <h6>2.4K Streaming</h6>
                    </div>
                  </div>
                ...
                <div class="item">
                  <div class="thumb">
                    <img src="<?= $template ?>/images/featured-03.jpg" alt="">
                    <div class="hover-effect">
                      <h6>2.4K Streaming</h6>
                    </div>
                  </div>
          ...
          <div class="col-lg-4">
            <div class="top-downloaded">
              ...
              <ul>
                <li>
                  <img src="<?= $template ?>/images/game-01.jpg" alt="" class="templatemo-item">
                  <h4>Fortnite</h4>
                  <h6>Sandbox</h6>
                ...
                <li>
                  <img src="<?= $template ?>/images/game-02.jpg" alt="" class="templatemo-item">
                  <h4>CS-GO</h4>
                  <h6>Legendary</h6>
                  <span><i class="fa fa-star" style="color: yellow;"></i> 4.9</span>
                  <span><i class="fa fa-download" style="color: #ec6090;"></i> 2.2M</span>
              ...
              <div class="text-button">
                <a href="http://localhost/activello/profile">View All Games</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-12">
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="item">
                  <div class="icon">
                    <img src="<?= $template ?>/images/service-01.jpg" alt="" style="max-width: 60px; border-radius: 50%;">
                  </div>
              ...
              <div class="col-lg-4">
                <div class="item">
                  <div class="icon">
                    <img src="<?= $template ?>/images/service-02.jpg" alt="" style="max-width: 60px; border-radius: 50%;">
                  </div>
              ...
              <div class="col-lg-4">
                <div class="item">
                  <div class="icon">
                    <img src="<?= $template ?>/images/service-03.jpg" alt="" style="max-width: 60px; border-radius: 50%;">
                  </div>
                  <h4>You Are Live</h4>
        ...
        <div class="live-stream">
          ...
          <div class="row">
            <div class="col-lg-3 col-sm-6">
              <div class="item">
                <div class="thumb">
                  <img src="<?= $template ?>/images/stream-01.jpg" alt="">
                  <div class="hover-effect">
                    <div class="content">
                      <div class="live">
                        <a href="#">Live</a>
                ...
                <div class="down-content">
                  <div class="avatar">
                    <img src="<?= $template ?>/images/avatar-01.jpg" alt="" style="max-width: 46px; border-radius: 50%; float: left;">
                  </div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="item">
                <div class="thumb">
                  <img src="<?= $template ?>/images/stream-02.jpg" alt="">
                  <div class="hover-effect">
                    <div class="content">
                      <div class="live">
                        <a href="#">Live</a>
                ...
                <div class="down-content">
                  <div class="avatar">
                    <img src="<?= $template ?>/images/avatar-02.jpg" alt="" style="max-width: 46px; border-radius: 50%; float: left;">
                  </div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="item">
                <div class="thumb">
                  <img src="<?= $template ?>/images/stream-03.jpg" alt="">
                  <div class="hover-effect">
                    <div class="content">
                      <div class="live">
                        <a href="#">Live</a>
                ...
                <div class="down-content">
                  <div class="avatar">
                    <img src="<?= $template ?>/images/avatar-03.jpg" alt="" style="max-width: 46px; border-radius: 50%; float: left;">
                  </div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="item">
                <div class="thumb">
                  <img src="<?= $template ?>/images/stream-04.jpg" alt="">
                  <div class="hover-effect">
                    <div class="content">
                      <div class="live">
                        <a href="#">Live</a>
                ...
                <div class="down-content">
                  <div class="avatar">
                    <img src="<?= $template ?>/images/avatar-04.jpg" alt="" style="max-width: 46px; border-radius: 50%; float: left;">
                  </div>
            ...
            <div class="col-lg-12">
              <div class="main-button">
                <a href="http://localhost/activello/streams">Discover All Streams</a>
              </div>
            </div>
          </div>
        </div>
